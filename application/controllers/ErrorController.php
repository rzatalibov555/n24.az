        ...
        if (strpos($current_route, 'admin') === 0) {
            ...
            $context = [
                ...
                "breadcrumbs" => [
                    ...
                    [
                        "title" => $this->lang->line("page_not_found"),
                        "url" => base_url('page_not_found'),
                        "active" => true
                    ]
                ],
            ...
            $this->load->view('admin/errors/error_404', $context);
            return;

        } else {
            // ✅ Frontend → Heç bir data yükləmə → UserController error_404-ə get
            $lang = $this->uri->segment(1);
            if (!in_array($lang, ['az', 'en'], true)) {
                $lang = 'az';
            }
            ...
            $this->load->view('front/errors/error_404', $data);
            return;
