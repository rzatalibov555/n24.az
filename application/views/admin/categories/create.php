        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form action="<?= base_url('admin/categories/store'); ?>" method="POST" enctype="application/x-www-form-urlencoded">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input name="category_name_az" type="text" class="form-control" placeholder="Siyasət" id="category_name_az" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input name="category_name_en" type="text" class="form-control" placeholder="Politics" id="category_name_en" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input name="category_name_ru" type="text" class="form-control" placeholder="Политика" id="category_name_ru" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-3">
                                <div class="form-check form-switch mb-2">
                                    <input name="category_status" type="checkbox" class="form-check-input" id="categoryStatus" checked>
