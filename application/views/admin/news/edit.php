                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="type" id="type" class="form-select">
                                        <option value="daily_news"
                                            <?php if (isset($news['type']) && $news['type'] == 'daily_news') {
                                                echo 'selected';
                                            } ?>>
                                        ...
                                        <option value="important_news_1"
                                            <?php if (isset($news['type']) && $news['type'] == 'important_news_1') {
                                                echo 'selected';
                                            } ?>>
                                        ...
                                        <option value="important_news_2"
                                            <?php if (isset($news['type']) && $news['type'] == 'important_news_2') {
                                                echo 'selected';
                                            } ?>>
                                        ...
                                        <option value="important_news_3"
                                            <?php if (isset($news['type']) && $news['type'] == 'important_news_3') {
                                                echo 'selected';
                                            } ?>>
                                        ...
                                        <option value="important_news_4"
                                            <?php if (isset($news['type']) && $news['type'] == 'important_news_4') {
                                                echo 'selected';
                                            } ?>>
                                        ...
                                        <option value="important_news_lent"
                                            <?php if (isset($news['type']) && $news['type'] == 'important_news_lent') {
                                                echo 'selected';
                                            } ?>>
                                        ...
                                        <option value="interview"
                                            <?php if (isset($news['type']) && $news['type'] == 'interview') {
                                                echo 'selected';
                                            } ?>>
                                        ...
                                        <option value="general_news"
                                            <?php if (isset($news['type']) && $news['type'] == 'general_news') {
                                                echo 'selected';
                                            } ?>>
