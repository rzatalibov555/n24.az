            ...
            <div class="col-md-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        ...
                        <span>
                            <?php
                            $segment2 = $this->uri->segment(2); // bolme / section
                            $segment3 = $this->uri->segment(3); // slug

                            if ($segment2 == 'bolme' || $segment2 == 'section') {
                                ...
                                echo $special_titles[$segment3][$lang] ?? '—';
                            } else {
                                // ✅ Normal kateqoriya breadcrumb adı
