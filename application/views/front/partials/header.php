                ...
                <div class="topbar-right ms-auto justify-content-center">
                  <div class="dropdown right-menu d-inline-flex news-language">
                    ...
                    <div class="dropdown-menu mt-0" aria-labelledby="dropdownMenuButton2">
                      <a class="dropdown-item" href="#"><img class="img-fluid country-flag" src="<?php echo base_url('public/front/') ?>images/country-flags/02.jpg" alt="">English</a>
                      <a class="dropdown-item" href="#"><img class="img-fluid country-flag" src="<?php echo base_url('public/front/') ?>images/country-flags/12.jpg" alt="">Azərbaycan</a>
                    </div>
                  </div>
    ...
    <nav class="navbar navbar-expand-lg">
      <div class="container position-relative">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav">
            <li class="nav-item active"> <a class="nav-link" href="<?php echo base_url('index') ?>"><?php echo $this->lang->line('home'); ?></a></li>
            <?php foreach ($main_categories as $cat): ?>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('category/' . $cat['slug']); ?>">
                  <?php echo strtoupper($cat['name_' . $lang]); ?>
                </a>
              </li>
            <?php endforeach; ?>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/technology/menu/01.jpg" alt=""> </div> <span class="badge badge-large bg-primary">Vehicle</span>
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/technology/menu/02.jpg" alt=""> </div> <span class="badge badge-large bg-blue">Touchless</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/technology/menu/03.jpg" alt=""> </div> <span class="badge badge-large bg-red">Gadgets</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/technology/menu/04.jpg" alt=""> </div> <span class="badge badge-large bg-yellow">Earbuds</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/technology/menu/05.jpg" alt=""> </div> <span class="badge badge-large bg-red">eyeprint</span>
                            <div class="blog-post-details">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="inner-mega-menu">
                      <div class="row">
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> 
                              <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/sport/menu/01.jpg" alt=""> 
                            </div> 
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/sport/menu/02.jpg" alt=""> </div> <span class="badge badge-large bg-primary">Pool</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/sport/menu/03.jpg" alt=""> </div> <span class="badge badge-large bg-purple">Rugby</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/sport/menu/04.jpg" alt=""> </div> <span class="badge badge-large bg-red">Boxing</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/sport/menu/05.jpg" alt=""> </div> <span class="badge badge-large bg-yellow">Volleyball</span>
                            <div class="blog-post-details">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="inner-mega-menu">
                      <div class="row">
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/entertainment/menu/01.jpg" alt=""> </div> <span class="badge badge-large bg-orange">Nightclubs</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/entertainment/menu/02.jpg" alt=""> </div> <span class="badge badge-large bg-blue">Dance</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/entertainment/menu/03.jpg" alt=""> </div> <span class="badge badge-large bg-primary">Music</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/entertainment/menu/04.jpg" alt=""> </div> <span class="badge badge-large bg-red">Movies</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/entertainment/menu/05.jpg" alt=""> </div> <span class="badge badge-large bg-purple">Video Games</span>
                            <div class="blog-post-details">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="inner-mega-menu">
                      <div class="row">
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/politician/menu/01.jpg" alt=""> </div> <span class="badge badge-large bg-primary">Lider</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/politician/menu/02.jpg" alt=""> </div> <span class="badge badge-large bg-red">Politician</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/politician/menu/03.jpg" alt=""> </div> <span class="badge badge-large bg-blue">Events</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/politician/menu/04.jpg" alt=""> </div> <span class="badge badge-large bg-pink">People</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/politician/menu/05.jpg" alt=""> </div> <span class="badge badge-large bg-yellow">Candidates</span>
                            <div class="blog-post-details">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="inner-mega-menu">
                      <div class="row">
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/magazine/menu/01.jpg" alt=""> </div> <span class="badge badge-large bg-primary">Fashion</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/magazine/menu/02.jpg" alt=""> </div> <span class="badge badge-large bg-red">Travel</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/magazine/menu/03.jpg" alt=""> </div> <span class="badge badge-large bg-skyblue">Photography</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/magazine/menu/04.jpg" alt=""> </div> <span class="badge badge-large bg-orange">Model</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/magazine/menu/05.jpg" alt=""> </div> <span class="badge badge-large bg-purple">Style</span>
                            <div class="blog-post-details">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="inner-mega-menu">
                      <div class="row">
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/life-style/menu/01.jpg" alt=""> </div> <span class="badge badge-large bg-skyblue">Lifestyle</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/life-style/menu/02.jpg" alt=""> </div> <span class="badge badge-large bg-orange">Fashion</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/life-style/menu/03.jpg" alt=""> </div> <span class="badge badge-large bg-red">Beauty</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/life-style/menu/04.jpg" alt=""> </div> <span class="badge badge-large bg-blue">Model</span>
                            <div class="blog-post-details">
                        ...
                        <div class="col">
                          <div class="blog-post post-style-02 mb-3">
                            <div class="blog-image"> <img class="img-fluid" src="<?php echo base_url('public/front/') ?>images/category/life-style/menu/05.jpg" alt=""> </div> <span class="badge badge-large bg-purple">Style</span>
                            <div class="blog-post-details">
            ...
            <?php if (!empty($other_categories)): ?>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <?php echo $this->lang->line('other'); ?><i class="fas fa-chevron-down fa-xs"></i>
                </a>
                  ...
                  <?php foreach ($other_categories as $cat): ?>
                    <li>
                      <a class="dropdown-item"
                        href="<?php echo base_url('category/' . $cat['slug']); ?>">
