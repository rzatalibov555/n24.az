      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container position-relative">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown active"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown02" role="button" data-bs-toggle="dropdown" aria-expanded="false">Pages<i class="fas fa-chevron-down fa-xs"></i></a>
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown02">
                <li class="active"><a class="dropdown-item" href="about-us.html">About Us</a></li>
          ...
          <div class="col-lg-7 col-xl-8">
            <div class="row">
              <div class="col-sm-8 mb-4 mb-sm-0">
                 <img class="img-fluid border-radius" src="images/about/01.jpg" alt="">
              </div>
              <div class="col-sm-4">
              ...
              <div class="row">
                  <div class="col-12">
                   ...
                   <img class="img-fluid border-radius mb-3" src="images/about/03.jpg" alt="">
