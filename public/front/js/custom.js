...
POTENZA.isSticky = function () {
  $(window).scroll(function(){
    if ($(this).scrollTop() > 150) {
       ...
       $('.space-ptb').addClass('padding_scroll');
       $('.news-politics-post').addClass('padding_scroll_index');
      //  $('.space-ptb').addClass('animate__animated animate__fadeIn');
    } else {
       $('.header-sticky').removeClass('is-sticky');
       $('.space-ptb').removeClass('padding_scroll');
       $('.news-politics-post').removeClass('padding_scroll_index');
      //  $('.space-ptb').removeClass('animate__animated animate__fadeIn');
    }
  });
};
